...
function Card(props) {
  ...
  return (
    <article className="element">
      <button type="button" aria-label="trash" className="element__trash" onClick={handleDellClick}></button>
      ...
      <div className="element__info">
        ...
        <div className="element__row">
          <button type="button" aria-label="like" className="element__like"></button>
